    ...
    <>
      ...
      <div className="w-5/6 mx-auto pt-12  ">
        <div>
          ...
          <h1 className="text-xl text-neutral-500  pt-2 pb-3">
            You can choose to display featured
          </h1>
          <div className="border-t-2 w-16 pb-6 border-red-500"></div>
          <div className="flex flex-col md:flex-row md:flex-wrap justify-between pt-8 "></div>
              ...
              <div className="lg:w-1/3 lg:p:8 w-full border-2 border-gray-200 pb-9  ">
                ...
                <div className="p-6">
                  ...
                  <div className="items-center flex text-lg text-neutral-500 space-x-2 pt-3">
                    ...
                    <span className=" hover:text-red-400 cursor-pointer text-neutral-500 ">
                      Hotel Ambassador,{" "}
                    </span>
                    <span className=" hover:text-red-400 cursor-pointer text-neutral-500">
                      {" "}
                  ...
                  <div className="flex justify-between items-center pt-5">
                    <button className="py-2 px-4 text-lg font-semibold border-2 border-solid border-gray-400 hover:bg-red-300 hover:text-white">
                      Get Ticket
                    </button>
